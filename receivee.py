...
class receivee(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "receivee")
        ...
        self.rtlsdr_source_0.set_center_freq(101.7e6, 0)
...
def main(top_block_cls=receivee, options=None):
